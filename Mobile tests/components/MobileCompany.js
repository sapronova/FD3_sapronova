  ...
  render() {
    ...
    return (
      ...
      <div className='MobileCompany'>
        <input type="button" className="mts" value="MTS" onClick={this.setName1} />
        <input type="button" value="Velcom" onClick={this.setName2} />
        
        <div className='MobileCompanyName'>Компания &laquo;{this.state.name}&raquo;</div>
        <input type="button" id="Все" className="All" onClick={this.changeListMode}/>
        <input type="button" value="Активные" className="ButtonActive" onClick={this.changeListMode}/>
        <input type="button" value="Заблокированные"  className="ButtonBlocked" onClick={this.changeListMode}/>
        ...
        <input type="button" className='AddNewClient'  value="Добавить клиента" onClick={this.addnewClient}  disabled={this.state.typeMode}/>
