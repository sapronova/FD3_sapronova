    ...
    return (
     /* <div className='MobileClient'>
      ...
      <tr className='MobileClient'>
          ...
          <td><input type="button" className='Edit' value="Редактировать" onClick={this.edit} /> </td>
          <td><input type="button" className='Delete' value="Удалить" onClick={this.delete} /> </td>
      </tr>
    );
